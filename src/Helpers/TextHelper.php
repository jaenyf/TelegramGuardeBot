...
class TextHelper
{
    private const homoglyphes = array(
        ...
        "c" => "𐐽ᴄⲥ𝖼𝘤𝒸𝙘𝒄𝓬ꮯᏟϲ𝐜с𝕔𝗰Ⅽ𝔠𺀠c𝚌𝑐𝖈ⅽｃ𐐠",
        "d" => "𝗱ꓒ𝙙𝕕ԁᏧ𝒹ɗ𝖽𝘥ḏďｄ𝒅dɖ𝚍ᑯⅾ𝓭𝐝ḓ𝑑ժḑḋ𝔡đcḍb𝖉ⅆ",
        "e" => "ꬲ𝖊𝕖𝚎℮êė𝔢ⅇȩҽ𝖾ē𝒆ḛĕ𝑒ɇ𝓮ẹℯ𝙚ę𝘦ée𝐞ëèеěcｅ𝗲",
        "f" => "𝔣𝙛ꞙ𝒻𝚏ƒｆ𝑓𝗳ẝf𝕗𝒇𝟋𝓯ք𝘧ꬵſ𝖿𝐟𝖋ϝḟꜰ",
        "g" => "ɡᶃ𝗴𝔤ɢǧ𝐠g𝘨qģ𝕘ｇնցġℊ𝗀ĝ𝒈ǥ𝚐ƍ𝓰𝙜𝑔𝖌ğǵ",
        "h" => "ħȟհᏂⱨ𝚑ẖһ𝔥𝒽ḥḩ𝖍ℎ𝕙𝘩𝗁𝐡ɦ𝒉𝗵ｈhĥḧ𝓱𝙝ḣḫ",
        "i" => "ι𝝸iᛁɨꭵا𝚤𰰠𝐢𝑖𝕚𝚒1ȋᎥ˛𐐠⍳𝜄𝗂ιіꙇⅰ𝛊ɪ𝖎ỉīĭｉͺ𝒾𝓲íɩℹ𝔦𝗶𑣃𝜾𝞲ịǐïⅈı𝘪ì𝒊",
        "j" => "𝔧𝚓jϳ𝗷𝐣𝙟𝒋𝗃յ𝒿𝑗𝖏ɉ𝘫ʝјⅉ𝕛ｊ𝓳",
        "k" => "𝐤𝑘𝗄𝗸𝚔ḳḵ𝓴𝓀ｋκⱪ𝕜k𝔨𝖐𝒌ķ𝙠𝘬ᴋ",
        "l" => "l",
        "m" => "ᴍｍmṁⅿḿṃɱn",
        "n" => "𝓃ｎ𝚗ñ𝐧𝒏ռ𝙣mꞑ𝗇𝘯ṅńņ𝓷𝗻ǹɴnṇň𝑛ṉո𝕟𝖓𝔫",
        "o" => "ᴏ",
        "p" => "ƥ𝗉ṗᏢ𝝆ṕ𝒑𝛒𝕡𝔭ｐ𝚙ρ𝝔⍴𝜌𝞀𝓹ƿϱⲣ𝑝Ｐ𝖕𝞺p𝓅𝐩р𝙥𝞎𝘱𝛠𝗽𝟈𝜚",
        "q" => "𝐪𝖖g𝑞գｑʠq𝘲𝚚ԛ𝕢𝓆𝔮𝗾𝒒𝗊Ⴓ𝙦զ𝓺",
        "r" => "𝓇𝐫ṛrᴦꭈ𝑟ɼṙṟ𝘳ꭇ𝗿ȑ𝗋Իгɾŕɍȓ𝔯ⲅŗｒ𝒓ř𝙧ʀɽ𝚛ꮁ𝖗𝕣𝓻",
        "s" => "𵠠ꜱ𑣁𝘀ႽЅṣƽ𝓼ŝṡ𐑈Ｓʂ𝑠𐐠ś𝙨𝓈S𝖘sｓ𝕤Ꮪ𝐬𝔰𝗌𝚜ѕ𝒔ꮪ𝘴șšՏ",
        "t" => "𝐭𝒕𝑡ṫᎢ𝖙ț𝘁𝓽ƫτ𝔱ţ𝙩ｔ𝓉𝗍𝘵𝚝ṭt𝕥ŧ",
        "u" => "𝕦𑣘ůūǔùUꭎｕՍＵųűư𝗎ꞟʉսûԱ𝖚𝐮𝞄𝘂𝘶𝛖𐓶𝜐úuũȗụ𝒖𝓊𝔲üυμ𝝊ʋ𝑢ŭȕ𝞾𝓾𝙪𝚞ᴜꭒ",
        "v" => "𝒗⋁𝚟𑣀𝗏ѵѴ𝜈𝞶𝑣𝓋𝐯𝔳𝘃ｖ𝝼vⱱνטⱴ𝖛ᴠ𝘷∨ⅴ𝙫𝕧ṽꮩ𝓿ṿᶌ𑜆𝛎𝝂",
        "w" => "𑜊ẅ𝑤𑜎𝘄ẘ𝖜ɯ𝒘𝔀Ｗ𝗐𝘸vｗ𝚠ẇẁ𝐰ẉWwẃ𝔴ԝꮃ𝕨աⱳ𑜏𝙬Ꮃŵᴡ𝓌ѡ",
        "x" => "ｘ𝐱⤬𝘅𝙭𝓍𝔁ᕽⅩᕁ𝗑𝖝𝑥᙮х𝚡𝔵×⤫ⅹχ𝒙𝘹x⨯𝕩",
        "y" => "𝛄𝕪𝓎ʏɣ𝗒ｙ𝒚Үŷγƴ𝚢ỿ𝛾𑣜ℽ𝞬ɏꭚẏ𝔂𝔶ყ𝝲ỵ𝘆ү𝖞ȳyýÿу𝘺𝙮𝑦ＹYᶌΥ𝐲𝜸",
        ...
        "O" => "οΟｏՕО0𱠠ＯoOо𐐠",
        "P" => "𝙋𝑷𝜬Ꮲ𝞠ꮲ𝚸ℙ𝘗𝙿РᑭΡꓑ𝐏𝝦ᴩ𝓟𐊕𝖯𝛲ⲢᴘPＰ𝔓𝑃𝒫𝗣𝕻",
